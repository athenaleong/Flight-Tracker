...
extension FlightInfoViewController {
    func setupUI() {
        ...
        planeTypeLabel.textColor = .black
        ...
        startAirportLabel.textColor = .black
        ...
        endAirportLabel.textColor = .black
        ...
        startTerminalLabel.textColor = .black
        ...
        endTerminalLabel.textColor = .black
        ...
        startGateLabel.textColor = .black
